    ...
    public partial class Keyboardcontrol : UserControl
    {
        ...
        public BoW KeyboardType
        {
            ...
            set
            {
                ...
                {
                    pictureBoxKeyboard.Image = MontgomerySoftware.Controls.Properties.Resources.keyboard_white;
                    pictureBoxCapsLockDown.Image = MontgomerySoftware.Controls.Properties.Resources.caps_down_white;
                    pictureBoxLeftShiftDown.Image = MontgomerySoftware.Controls.Properties.Resources.shift_down_white;
                    pictureBoxRightShiftDown.Image = MontgomerySoftware.Controls.Properties.Resources.shift_down_white;
                }
                else if (pvtKeyboardType==BoW.Alphabetical)
                {
                    pictureBoxKeyboard.Image = MontgomerySoftware.Controls.Properties.Resources.keyboard_alphabetical;
                    pictureBoxCapsLockDown.Image = MontgomerySoftware.Controls.Properties.Resources.caps_down_white;
                    pictureBoxLeftShiftDown.Image = MontgomerySoftware.Controls.Properties.Resources.shift_down_white;
                    pictureBoxRightShiftDown.Image = MontgomerySoftware.Controls.Properties.Resources.shift_down_white;
                }
                ...
                {
                    pictureBoxKeyboard.Image = MontgomerySoftware.Controls.Properties.Resources.keyboard_kids_lower;
                }
            }
        }
        ...
        private void HandleCapsLock()
        {
            if (capslockindicator)
            {
                ...
                if (pvtKeyboardType == BoW.Kids) pictureBoxKeyboard.Image = MontgomerySoftware.Controls.Properties.Resources.keyboard_kids_lower;
            }
            else
            {
                capslockindicator = true;
                if (pvtKeyboardType == BoW.Kids) pictureBoxKeyboard.Image = MontgomerySoftware.Controls.Properties.Resources.keyboard_kids_upper;
